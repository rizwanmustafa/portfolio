...
const projects: Array<{ name: string, description: string, repoLink: string, type: string, technologies: string[], liveURL?: string }> = [
	...
	// },
	{
		name: "Test Type",
		type: "Web Application",
		technologies: ["Javascript", "Flask", "Python", "MySQL"],
	...
	},
	{
		...
		description: "This is my portfolio website. It is a simple website that I made to showcase my skills and projects.",
		repoLink: "https://github.com/rizwanmustafa/portfolio",
	}
];
